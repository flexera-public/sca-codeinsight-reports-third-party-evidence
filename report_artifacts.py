...
def generate_html_report(reportData):
    ...
    html_ptr.write("        <tr>\n")
    html_ptr.write("            <th colspan='10' class='text-center'><h4>Files with Third Party Evidence</h4></th>\n") 
    html_ptr.write("        </tr>\n") 
    html_ptr.write("        <tr>\n")
    html_ptr.write("            <th style='width: 50%' class='text-left text-nowrap'>File Path</th>\n") 
    html_ptr.write("            <th style='width: 5%' class='text-center'>Copyright</th>\n") 
    html_ptr.write("            <th style='width: 5%' class='text-center'>License</th>\n")
    html_ptr.write("            <th style='width: 5%' class='text-center'>Email/URL</th>\n")
    ...
    for filePath in sorted(fileEvidence):
        ...
        for evidence in ["copyright", "license", "emailURL", "searchTerm", "exactMatch", "sourceMatch"]:
            ...
            if evidence in fileEvidence[filePath]["evidence"]:
                html_ptr.write("            <td class='text-center text-nowrap'><span class='dot dot-%s'></span></td>\n" %evidence)
            else:
